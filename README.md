...
The frontend was made with react and can be found [here](https://github.com/Johnadibe/hello_react_frontend)
...
```sh
  cd my-folder
  git clone https://github.com/Johnadibe/hello_rails_backend.git
```
